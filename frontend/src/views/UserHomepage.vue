...
const isMerchantProfile = computed(() => user.value.role === 'merchant' || user.value.isMerchant)
...
const roleLabel = computed(() => isMerchantProfile.value ? '商家' : '用户')
const roleIcon = computed(() => isMerchantProfile.value ? 'bx bxs-store' : 'bx bx-user')
