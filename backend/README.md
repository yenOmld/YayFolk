...
```properties
# 数据库配置
spring.datasource.url=jdbc:mysql://localhost:3306/yayfolk?useSSL=false&serverTimezone=UTC&characterEncoding=utf8
...
2. 等待依赖下载完成
3. 运行 `YayFolkApplication.java` 类
