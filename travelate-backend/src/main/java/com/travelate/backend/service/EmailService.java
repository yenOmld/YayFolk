...
import com.travelate.backend.utils.VerificationCodeUtil;
    ...
    public void sendVerificationCode(String toEmail) {
        ...
        MimeMessagePreparator preparator = new MimeMessagePreparator() {
            public void prepare(MimeMessage mimeMessage) throws Exception {
                ...
                mimeMessage.setFrom(new InternetAddress(fromEmail, "Travelate", "UTF-8"));
                mimeMessage.setSubject("Travelate 验证码");
                mimeMessage.setText("您好，欢迎使用译行 Travelate，很高兴成为您路途中的智能伙伴！\n\n您的验证码是: " + code + "\n\n该验证码5分钟内有效，请勿泄露给他人。");
            }
        };
