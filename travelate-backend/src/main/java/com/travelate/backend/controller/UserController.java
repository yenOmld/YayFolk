...
import com.travelate.backend.util.OssUtil;
import com.travelate.backend.repository.DiscoverPostRepository;
...
public class UserController {
    ...
    public ResponseDto deleteAccount(HttpServletRequest request) {
        try {
            ...
            // 删除用户所有帖子的图片
            List<com.travelate.backend.entity.DiscoverPost> posts = postRepository.findByUserId(userId);
            for (com.travelate.backend.entity.DiscoverPost post : posts) {
                try {
